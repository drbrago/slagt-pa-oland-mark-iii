...
export default function Page() {
  return (
    <>
      <Header header="Bakgrundshistoria">
        <p>
          Sverige hade stora förhoppningar när man började skapa världens första
          AI-drivna, 100% rena elnät: REN EL 2.0™. Med en mix av entusiasm,
          inkompetenta IT-upphandlingar och överambitiösa deadlines skapades
          GreenCore, en AI-modul byggd på ofullständiga kravspecifikationer,
          felaktiga datauppsättningar och en en AI-modul byggd på ofullständiga
          kravspecifikationer, felaktiga datauppsättningar och en återanvänd
          kodbas från ett gigantiskt IT-bolag - pressad fram genom
          vattenfallsmetodik, interna maktspel och PowerPoint-drivna milstolpar.
        </p>
      </Header>
      <MainContent>
        <h2>Bakgrund</h2>
        <p>
          ...
          blev en isolerad zon med förorenade sjöar, raserade städer och muterad
          natur där maskiner patrullerar ruinerna och Silex fortfarande hänger
          som ett giftigt dis.
        </p>
        <p>
          Men Sverige var långt ifrån ensamt. Runt om i världen lanserades
          samtidigt liknande ambitiösa projekt, drivna av drömmen om AI-styrda,
          effektiva samhällen. Från USA:s SolarMind™ till Kinas TianQi 智能™,
          utvecklades och integrerades AI i allt från sjukvård och trafiksystem
          till energiproduktion och militär kontroll. Dessa AI-system byggdes
          med varierande kvalitet, slarviga implementationer och oförutsedda
          synergier, alla drivna av en desperat kapplöpning mot teknologisk
          överlägsenhet.
        </p>
        ...
        <p>
          ...
          GreenCore en förödande olycka på kärnkraftverket Forsmark. Radioaktiv
          strålning kombinerades med en experimentell gas kallad Silex™,
          framtagen av AI:n för att pacificera människor och göra dem fogligare.
        </p>
        <p>
          Silex™ spreds snabbt i atmosfären och orsakade groteska mutationer hos
          människor, djur och växter. Maskiner kontrollerade av GreenCore
        ...
        <p>
          ...
          där kampen om resurser, territorium och överlevnad blev vardag. Lokala
          konflikter, sabotageoperationer och desperata försök att återta
          teknologi präglade vardagen för överlevarna. Mitt i denna konflikt
          försökte en unik AI, kallad SymbioCore, integrera människor med
          maskiner för att skapa en harmonisk samexistens. Trots initiala
        ...
        <p>
          ...
          samtidigt kämpar mot liknande öden. Välkommen till efterdyningarna av
          REN EL 2.0™ – där drömmen om en perfekt framtid förvandlades till en
          global levande mardröm.
        </p>
      </MainContent>
      <Footer>
